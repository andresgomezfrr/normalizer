...
public class KafkaMetricListenerIntegrationTest {
    ...
    public void kafkaMetricListenerShouldWork() throws Exception {
        ...
        config.put("metric.listeners", Collections.singletonList("zz.ks.metrics.KafkaMetricListener"));
        ...
        config.put(Config.ConfigProperties.BOOTSTRAPER_CLASSNAME, "zz.ks.builder.bootstrap.FileBootstraper");
